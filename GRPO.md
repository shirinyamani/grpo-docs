...
In RLHF, the two distributions of interest are often the distribution of the new model version, say $P_(x)$, and a distribution of the reference policy, say $Q(x)$.
